...
class FormulaAnteojos extends Model implements AuditableContract
{
    ...
    static $rulesStore = [
        ...
        'hirschberg'            => 'nullable|string',
        'cover_test'            => 'nullable|string',
        'ppc'                   => 'nullable|string',
        'motilidad_ocular'      => 'nullable|string',
        'bio_od_par'            => 'nullable|string',
        'bio_od_ang'            => 'nullable|string',
        'bio_od_cri'            => 'nullable|string',
        'bio_od_con'            => 'nullable|string',
        'bio_od_iris'           => 'nullable|string',
        'bio_od_pro'            => 'nullable|string',
        'bio_od_cor'            => 'nullable|string',
        'bio_od_rpu'            => 'nullable|string',
        'bio_od_dil'            => 'nullable|string',
        'bio_oi_par'            => 'nullable|string',
        'bio_oi_ang'            => 'nullable|string',
        'bio_oi_cri'            => 'nullable|string',
        'bio_oi_con'            => 'nullable|string',
        'bio_oi_iris'           => 'nullable|string',
        'bio_oi_pro'            => 'nullable|string',
        'bio_oi_cor'            => 'nullable|string',
        'bio_oi_rpu'            => 'nullable|string',
        'bio_oi_dil'            => 'nullable|string',
        'fon_od_pap'            => 'nullable|string',
        'fon_od_vit'            => 'nullable|string',
        'fon_od_mac'            => 'nullable|string',
        'fon_od_per'            => 'nullable|string',
        'fon_od_vre'            => 'nullable|string',
        'fon_od_retina'         => 'nullable|string',
        'fon_oi_pap'            => 'nullable|string',
        'fon_oi_vit'            => 'nullable|string',
        'fon_oi_mac'            => 'nullable|string',
        'fon_oi_per'            => 'nullable|string',
        'fon_oi_vre'            => 'nullable|string',
        'fon_oi_retina'         => 'nullable|string',
