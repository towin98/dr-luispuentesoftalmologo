...
class FormulaAnteojos extends Model
{
    ...
    static $rulesStore = [
        ...
        'avs_sc_od'             => 'nullable|string|max:25',
        'avs_sc_oi'             => 'nullable|string|max:25',
        'avs_cc_od'             => 'nullable|string|max:25',
        'avs_cc_oi'             => 'nullable|string|max:25',
        'rx_od'                 => 'nullable|string|max:25',
        'rx_oi'                 => 'nullable|string|max:25',
        'adicion'               => 'nullable|string|max:25',
        'dp'                    => 'nullable|string|max:25',
        'observacion'           => 'nullable|string',
        'ref_obj_od'            => 'nullable|string|max:25',
        'ref_obj_oi'            => 'nullable|string|max:25',
        'ref_sub_od'            => 'nullable|string|max:25',
        'ref_sub_oi'            => 'nullable|string|max:25',
        'que_od'                => 'nullable|string|max:25',
        'que_oi'                => 'nullable|string|max:25',
        'hirschberg'            => 'nullable|string|max:25',
        'cover_test'            => 'nullable|string|max:25',
        'ppc'                   => 'nullable|string|max:25',
        'motilidad_ocular'      => 'nullable|string|max:25',
        'dilatacion_pupilar'    => 'nullable|string|max:25',
        'papilas'               => 'nullable|string|max:25',
        'bio_od_par'            => 'nullable|string|max:25',
        'bio_od_ang'            => 'nullable|string|max:25',
        'bio_od_cri'            => 'nullable|string|max:25',
        'bio_od_con'            => 'nullable|string|max:25',
        'bio_od_iris'           => 'nullable|string|max:25',
        'bio_od_pro'            => 'nullable|string|max:25',
        'bio_od_cor'            => 'nullable|string|max:25',
        'bio_od_rpa'            => 'nullable|string|max:25',
        'bio_oi_par'            => 'nullable|string|max:25',
        'bio_oi_ang'            => 'nullable|string|max:25',
        'bio_oi_cri'            => 'nullable|string|max:25',
        'bio_oi_con'            => 'nullable|string|max:25',
        'bio_oi_iris'           => 'nullable|string|max:25',
        'bio_oi_pro'            => 'nullable|string|max:25',
        'bio_oi_cor'            => 'nullable|string|max:25',
        'bio_oi_rpa'            => 'nullable|string|max:25',
        'fon_od_pap'            => 'nullable|string|max:25',
        'fon_od_vit'            => 'nullable|string|max:25',
        'fon_od_mac'            => 'nullable|string|max:25',
        'fon_od_per'            => 'nullable|string|max:25',
        'fon_od_vre'            => 'nullable|string|max:25',
        'fon_od_retina'         => 'nullable|string|max:25',
        'fon_oi_pap'            => 'nullable|string|max:25',
        'fon_oi_vit'            => 'nullable|string|max:25',
        'fon_oi_mac'            => 'nullable|string|max:25',
        'fon_oi_per'            => 'nullable|string|max:25',
        'fon_oi_vre'            => 'nullable|string|max:25',
        'fon_oi_retina'         => 'nullable|string|max:25',
